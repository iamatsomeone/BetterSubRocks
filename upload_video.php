...
<?php if(!isset($_SESSION['siteusername'])) { header("Location: /sign_in?error=You%20need%20to%20be%20signed%20in%20to%20access%20this%20page!"); } ?>
<?php
	$__server->page_embeds->page_title = "SubRocks - Upload Video";
	$__server->page_embeds->page_description = "SubRocks is a site dedicated to bring back the 2012 layout of YouTube.";
	$__server->page_embeds->page_image = "/yt/imgbin/full-size-logo.png";
	$__server->page_embeds->page_url = "https://www.subrock.rocks/";
?>
<!DOCTYPE html>
<html>
	<head>
                        ...
                        <div class="www-upload-right">
                            ...
                            <div class="upload-stage-2-right" style="display: none;">
                                ...
                                <select style="margin-top:5px;" name="category" class="yt-uix-button yt-uix-button-default">
                                    <?php $categories = ["Film & Animation", "Autos & Vehicles", "Music", "Pets & Animals", "Sports", "Travel & Events", "Gaming", "People & Blogs", "Comedy", "Entertainment", "News & Politics", "Howto & Style", "Education", "Science & Technology", "Nonprofits & Activism", "shitposting"]; ?>
